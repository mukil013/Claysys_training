    ...
    editButton.addEventListener("click", () => {
      if(flag){
        ...
        updateBtn.addEventListener("click", () => {
          ...
          document.querySelector("#user-name")!.textContent = users[tempCounter].name
          document.querySelector("#user-email")!.textContent = users[tempCounter].email
          document.querySelector("#user-role")!.textContent = users[tempCounter].role
